...
const UserList = () => {
  ...
  useEffect(() => {
    axios
      .get("https://stormy-ridge-27884.herokuapp.com/users")
      .then((res) => {
        setUsers(res.data);
      })
      .catch((err) => {
...
const UserEditModel = ({ user, handleSubmit }) => {
  return (
    <Fragment>
      <button
        type="button"
        className="btn btn-info mr-1 text-white"
        data-bs-toggle="modal"
        data-bs-target={`#myModal${user.uid}`}
      >
...
const UserDetailEditForm = ({ user }) => {
  ...
  const [activation_wallet, setActivationWallet] = useState(
    user.wallet.activation_wallet
  );
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://stormy-ridge-27884.herokuapp.com/update_user/" + user.uid,
        {
          username,
          password,
          name,
          ...
          <div className="card-body">
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={head_member}
                onChange={(e) => setHeadMember(e.target.value)}
              />
            </div>
          </div>
        </div>
          ...
          <div className="panel-body">
            ...
            <div className="form-group">
              ...
              <input
                type="number"
                className="form-control w-100"
                id="activation_wallet"
                placeholder="Balance..."
                value={activation_wallet}
                onChange={(e) => setActivationWallet(e.target.value)}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Balance..."
                value={offer_wallet}
                onChange={(e) => setOfferWallet(e.target.value)}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <select
                className="form-control w-100"
                id="is_bank_locked"
                value={is_bank_locked}
                onChange={(e) => setIsBankLocked(e.target.value)}
              >
                <option value="">Select</option>
                <option value="true">Yes</option>
                <option value="false">No</option>
